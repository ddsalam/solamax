...
function pointer(generationId: string, n = 10): SaldoSnapshotPointer {
  return {
    ...
    awalPiutangLokalDebet: n,
    awalPiutangLokalKredit: 0,
    akhirPiutangLokalDebet: n + 1,
    akhirPiutangLokalKredit: 0,
    awalPiutangOnlineDebet: n + 2,
    awalPiutangOnlineKredit: 0,
    akhirPiutangOnlineDebet: n + 2 + 1,
    akhirPiutangOnlineKredit: 0,
    awalHutangLokalDebet: 0,
    awalHutangLokalKredit: n + 4,
    akhirHutangLokalDebet: 0,
    akhirHutangLokalKredit: n + 4 + 1,
    awalPiutangLokal: n,
  ...
  it("membaca pointer segar, meng-cache exact generation, dan mengembalikan rowset + metadata", async () => {
    ...
    expect(got).toEqual({
      ...
      metadata: {
        ...
        staleInvalidFrom: null,
        debetTotals: {
          awal: { piutangLokal: 10, piutangOnline: 12, hutangLokal: 0 },
          akhir: { piutangLokal: 11, piutangOnline: 13, hutangLokal: 0 },
        },
        kreditTotals: {
          awal: { piutangLokal: 0, piutangOnline: 0, hutangLokal: 14 },
          akhir: { piutangLokal: 0, piutangOnline: 0, hutangLokal: 15 },
        },
        totals: {
